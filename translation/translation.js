const translations = {
  ...
  pl: {
    "Single t": "Pojedynczy",
    "Local t": "Lokalny",
    "Customise t": "Dostosować",
    "Settings t": "Ustawienia",
    //Customise
    "Choose body": "Wybierz ciało",
    "Choose gun": "Wybierz broń",
    //Settings
    "For code": "Dla kodu",
    "For shooting": "Dla strzelania",
    "Choose line up": "Wybierz kolejkę w górę",
    "Choose line L": "Wybierz kolejkę L",
    "Choose line down": "Wybierz kolejkę w dół",
    "Choose line R": "Wybierz kolejkę R",
    "Shoot t": "Strzelać",
    "Shoot enemy": "Strzelać w wróga",
    "English t": "English",
    "Spanish t": "Espanola",
    "Polish t": "Polski",
    //Pause
