...
function Check_day() {
  ...
  Rules1_night("Container_rules1");
  Rules2_night("Container_rules2");
  Rules3_night("Container_rules3");
  Rules4_night("Container_rules4");
  Button_pause1_day ("Button_contineu");
...
function Check_night() {
  ...
  Rules1_day("Container_rules1");
  Rules2_day("Container_rules2");
  Rules3_day("Container_rules3");
  Rules4_day("Container_rules4");
  Button_pause1_night ("Button_contineu");
...
function Rules1_night(){
  let rules = document.getElementById("Container_rules1");
  rules.style.backgroundColor = "#383838"
}
function Rules1_day(){
  let rules = document.getElementById("Container_rules1");
  rules.style.backgroundColor = "#7c7c7c"
}
function Rules2_night(){
  let rules = document.getElementById("Container_rules2");
  rules.style.backgroundColor = "#383838"
}
function Rules2_day(){
  let rules = document.getElementById("Container_rules2");
...
function Rules3_night(){
  let rules = document.getElementById("Container_rules3");
  rules.style.backgroundColor = "#383838"
}
function Rules3_day(){
  let rules = document.getElementById("Container_rules3");
...
function Rules4_night(){
  let rules = document.getElementById("Container_rules4");
  rules.style.backgroundColor = "#383838"
}
function Rules4_day(){
  let rules = document.getElementById("Container_rules4");
...
function Single(){
  window.location.href = "../pause/pause.html";
}
function Button_pause1_night () {
  let but1 = document.getElementsByTagName("Button_continue");
  but1.classList.remove("button1_day");
  but1.classList.add("button1_night");
}
function Button_pause1_day () {
  let but1 = document.getElementsByTagName("Button_continue");
  but1.classList.remove("button1_night");
  but1.classList.add("button1_day");
}